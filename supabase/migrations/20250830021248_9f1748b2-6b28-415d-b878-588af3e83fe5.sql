-- Fix the provision_tenant function to use only valid table types
CREATE OR REPLACE FUNCTION public.provision_tenant(
  ...
  p_cuisine_type_id uuid DEFAULT NULL::uuid
)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  -- Create default tables for the restaurant using only valid table types
